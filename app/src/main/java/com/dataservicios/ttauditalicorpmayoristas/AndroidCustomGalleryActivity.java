...
import com.dataservicios.ttauditalicorpmayoristas.adapter.ImageAdapter;
        ...
        btn_photo.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v)
            {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    ...
                    Uri contentUri = FileProvider.getUriForFile(MyActivity, "com.dataservicios.ttauditalicorpmayoristas.fileProvider", file);
